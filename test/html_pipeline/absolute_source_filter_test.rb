...
class HTMLPipeline
  class AbsoluteSourceFilterTest < Minitest::Test
    AbsoluteSourceFilter = HTMLPipeline::AbsoluteSourceFilter
    ...
    def test_tells_you_where_context_is_required
      ...
      assert_match("HTMLPipeline::AbsoluteSourceFilter", exception.message)
